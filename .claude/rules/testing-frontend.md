...
For complex context trees, create a `__fixtures__/ContextWrapper.svelte` component that provides all required contexts and accepts the component under test as a snippet.
