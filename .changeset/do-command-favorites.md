...
- An "Add favorite" / "Remove favorite" toggle button renders beneath Execute with a star icon (outline when the current input is not yet saved, filled when it matches a saved favorite).
